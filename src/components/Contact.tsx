  ...
  const contactInfo = [
    {
      ...
      title: 'Location',
      details: 'Hanamkonda, India'
    },
    {
      icon: <Phone className="h-5 w-5 text-blue-500" />,
      title: 'Phone',
      details: '+91 6300251692'
    },
    {
      icon: <Mail className="h-5 w-5 text-blue-500" />,
      title: 'Email',
      details: 'chadajayasenareddy123@gmail.com'
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Have a project in mind or want to discuss potential opportunities? Feel free to reach out to me using
            the contact form below or through my contact information.
          </p>
        </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full flex items-center justify-center hover:bg-blue-200 dark:hover:bg-blue-800/30 transition-colors">
                  ...
                  <a href="#" className="w-10 h-10 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 rounded-full flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  className={`inline-flex items-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg transition-colors ${
